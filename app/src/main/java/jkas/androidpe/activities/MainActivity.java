...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadProjectView() {
        ...
        binding.linInfo.setVisibility(View.GONE);
    ...
    private void allOnClick() {
        binding.icSettings.setOnClickListener(
                (b) -> CodeUtil.startActivity(C, PreferencesActivity.class));
    ...
    private void loadListeners() {
        binding.swipeRefreshLayout.setOnRefreshListener(
                () -> {
                    binding.progressIndicator.setVisibility(View.VISIBLE);
                    new Handler(Looper.getMainLooper()).postDelayed(() -> loadProjectView(), 439);
                });
