...
public class FilesManager {
    ...
    private MainEditorView addMainEV(String path) {
        final String name = Files.getNameFromAbsolutePath(path);
    ...
    private void setCurrentOpenFile() {
        ...
        final MainEditorView mev = addMainEV(path);
        currentOpenedFile = mev;
        updateCurrentFile();
    }
    ...
    private void requestClose() {
        ...
        if (currentOpenedFile.isThereUnsavedContent()) {
            DialogBuilder.getDialogBuilder(
                    ...
                    .setPositiveButton(R.string.save, (d, v) -> currentOpenedFile.save())
                    .setNegativeButton(
                            R.string.close,
                            (d, v) -> {
